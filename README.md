...
Permite visualizar una lista de imágenes posibilitando la navegación entre éstas de atras hacia 
adelante y viceversa.

Desde el programa podremos cargar un directorio de imágenes y visualizarlas una a una, obteniendo 
a su vez información sobre las mismas, como su nombre, ruta, tamaño y resolución.
